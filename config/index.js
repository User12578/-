export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx8783abc2d45562d0",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "94d04d99fe9e74cffd7d9903b4c2c4a9",
  ...
  USERS: [
    {
      ...
      id: "oIy2O6RW9q0r_BQS1rLGev4gsW2c",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "D70WyBHcuaJxGU4lWiKFt528gnHkzduNPZHpHhjorO4",
      // 所在省份
      province: "黑龙江",
      // 所在城市
      city: "绥化",
